...
and any env without a collector don't block on span export. When enabled it
also instruments the outbound httpx client so upstream calls are traced.
"""
...
DEFAULT_SERVICE_NAME = "llm-gateway"
